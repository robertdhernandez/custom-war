...
class HostOnlyCreateException : public std::exception
{
public:
	const char * what() const throw() { return "Only the host can create a new map"; }
};

class HostOnlyResizeException : public std::exception
{
public:
	const char * what() const throw() { return "Only the host can resize the map"; }
};
